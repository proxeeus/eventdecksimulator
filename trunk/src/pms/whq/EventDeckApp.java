  ...
  implements ActionListener, FileFilter, WindowListener
{
  ...
  protected void layoutMainWindow() {
    ...
    if (img != null) {
      ...
      setSize(new java.awt.Dimension(Settings.getSettingAsInt(Settings.CARD_HEIGHT),
  ...
  protected void generateNextEventForDiceRoll() {
      // TODO -- Add this
  }
